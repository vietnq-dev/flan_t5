...
EXPERIMENTS = {
    ...
    "exp32": {
        "description": "Scaling model size (BoolQ / Elementary Math)",
        "configs": [
            "configs/exp32_scaling_model/flan_t5_small_boolq.yaml",
            "configs/exp32_scaling_model/flan_t5_base_boolq.yaml",
